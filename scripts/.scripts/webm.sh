#!/bin/bash
#
# Modified some stuff from a script by twilly , i think...
#
#
#
...
then
    ...
    ffmpeg -f pulse -ac 2 -i default -f x11grab -s "1366x768" -r 30 -i $DISPLAY -c:v libx264 -preset "ultrafast" -crf 10 -y "$TMP" 
else
